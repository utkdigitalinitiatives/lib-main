...
/**
 * Source plugin for section_embedded_video paragraphs used by eligible news.
 *
 * @MigrateSource(
 *   id = "eligible_news_embedded_video_paragraphs"
 * )
 */
class EligibleNewsEmbeddedVideoParagraphs extends SqlBase
{
  /**
   * {@inheritdoc}
   */
  public function query()
  {
    ...
    $query->addField(
      "pev",
      "field_embedded_video_target_id",
      "source_media_id",
    );
  ...
  public function fields()
  {
    return [
      ...
      "source_media_id" => $this->t("Source remote video media ID"),
