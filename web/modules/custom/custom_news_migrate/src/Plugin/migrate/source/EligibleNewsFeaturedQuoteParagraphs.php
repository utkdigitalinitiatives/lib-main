...
/**
 * Source plugin for featured_quote paragraphs used by eligible news nodes.
 *
 * @MigrateSource(
 *   id = "eligible_news_featured_quote_paragraphs"
 * )
 */
class EligibleNewsFeaturedQuoteParagraphs extends SqlBase
{
  /**
   * {@inheritdoc}
   */
  public function query()
  {
    ...
    $query->innerJoin(
      "paragraph__field_quote_content",
      "pq",
      "pq.entity_id = p.id",
    );
    $query->innerJoin(
    ...
    $query->addField("pq", "field_quote_content_value", "quote_value");
    $query->addField("pd", "field_publishing_date_value", "publishing_date");

    $query->condition("p.type", "featured_quote");
  ...
  public function fields()
  {
    return [
      ...
      "quote_value" => $this->t("Featured quote text"),
