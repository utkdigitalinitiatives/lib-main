...
/**
 * Source plugin for section_image paragraphs used by eligible news nodes.
 *
 * @MigrateSource(
 *   id = "eligible_news_section_image_paragraphs"
 * )
 */
class EligibleNewsSectionImageParagraphs extends SqlBase
{
  /**
   * {@inheritdoc}
   */
  public function query()
  {
    ...
    $query->condition("p.type", "section_image");
